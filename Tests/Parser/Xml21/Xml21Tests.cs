...
public class Xml21Tests {
  ...
  public async Task convertsBcfToJsonFiles21() {
    ...
    var markups = await BcfParser.ParseMarkups<bcf21.Markup, bcf21.VisualizationInfo>("Resources/TestBcf21.zip");
  ...
  public async Task convertsBcfRootsToJsonFiles30() {
    var extensions = await BcfParser.ParseExtensions<bcf30.Extensions>("Resources/TestBcf30.zip");
    var project = await BcfParser.ParseProject<bcf30.ProjectInfo>("Resources/TestBcf30.zip");
